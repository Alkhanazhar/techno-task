  ...
  return (
    <div className="bg-[#060606] text-white max-w-7xl mx-auto px-4 md:px-16 py-10 space-y-10">
      ...
      <div className="grid md:grid-cols-2 gap-8 bg-[#0a0a0a]  rounded-3xl">
        {/* Form */}
        <div className="space-y-4 border border-gray-700 bg-gray-200  p-5 rounded-lg">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
            <input
              ...
              className="bg-gray-200  border border-gray-700 px-4 py-3 rounded-lg  placeholder:text-neutral-600 focus:outline-none focus:ring-1 focus:ring-blue-500"
            />
            <input
              type="text"
              placeholder="Last Name"
              className="bg-gray-200  border border-gray-700 px-4 py-3 rounded-lg placeholder:text-neutral-600"
            />
            <input
              required
              type="text"
          ...
          <textarea
            ...
            className="w-full bg-gray-200  border border-gray-700 px-4 py-3 rounded-lg resize-none placeholder:text-neutral-600"
          ></textarea>
