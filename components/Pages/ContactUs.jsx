...
const ContactUs = ({ isCards = true }) => {
  return (
    <div className="bg-gradient-to-tl to-[#21082b] from-[#27022e]">
      <div className=" text-white max-w-7xl mx-auto px-4 md:px-16 py-10 space-y-10">
        ...
        <div className="grid md:grid-cols-2 gap-8 rounded-3xl">
          {/* Form */}
          <div className="space-y-4 border border-neutral-400 bg-gray-200  p-5 rounded-lg">
            <h2 className="text-3xl md:text-4xl font-semibold  bg-gradient-to-r to-[#B462CE] from-[#3F2AB2] text-transparent bg-clip-text">
              Contact Us
            </h2>
            <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
              <input
                ...
                className="bg-gray-200 text-black border border-neutral-400 px-4 py-3 rounded-lg  placeholder:text-neutral-600 focus:outline-none focus:ring-1 focus:ring-blue-500"
              />
              <input
                type="text"
                placeholder="Last Name"
                className="bg-gray-200  text-black  border border-neutral-400 px-4 py-3 rounded-lg placeholder:text-neutral-600"
              />
              <input
                required
                type="text"
